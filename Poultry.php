					...
					<div>
                        ...
                        <div class="picture_Style_div">
                            ...
                            <form action="Basket" method="post">
                                ...
                                <!-- Inputs holding info about products for basket page -->
                                <input type="hidden" value="images/chicken/Yarrah.jpg" name="path">
                                <input type="hidden" value="Chicken & Turkey" name="name">
                                <input type="hidden" value="1.10" name="prize">
                                
                                <!-- Actual view of pruduct and his details -->
                                <button type="submit" class="button_picture_content">
                                    <img src="images/chicken/Yarrah.jpg" class="content_Image">
                                    <br>Yarrah Organic Chicken & Turkey Pate With Aloe Vera (100g)<br>£1.10<br>
                                    <span style="font-size: 12px;">Delivery available from free for orders over £40
                                    <br>Organic Certifying Authority: Skal 1301<br></span>
                                </button>
                        ...
                        <div class="picture_Style_div">
                            ...
                            <form action="Basket" method="post">
                                ...
                                <!-- Inputs holding info about products for basket page -->
                                <input type="hidden" value="images/chicken/Cosi.jpg" name="path">
                                <input type="hidden" value="Turkey Sliced" name="name">
                                <input type="hidden" value="4.49" name="prize">
                                
                                <!-- Actual view of pruduct and his details -->
                                <button type="submit" class="button_picture_content">
                                    <img src="images/chicken/Cosi.jpg" class="content_Image">
                                    <br>Cosi Bio Turkey Sliced (80g)<br>£4.49<br>
                                    <span style="font-size: 12px;">Delivery available from free for orders over £40
                       ...
                       <div class="picture_Style_div">
                        ...
                        <form action="Basket" method="post">
                            ...
                            <!-- Inputs holding info about products for basket page -->
                            <input type="hidden" value="images/chicken/Box1.jpg" name="path">
                            <input type="hidden" value="Chicken Box" name="name">
                            <input type="hidden" value="40.00" name="prize">
                            
                            <!-- Actual view of pruduct and his details -->
                            <button type="submit" class="button_picture_content">
                                <img src="images/chicken/Box1.jpg" class="content_Image">
                                <br>Chicken Box<br>£40.00<br>
                                <span style="font-size: 12px;">Delivery available from free for orders over £40
                                <br>Feeds 4 People for approximately 6 Meals.

                                    Whole Chicken, Fillets, Legs, Minced Chicken, Diced Chicken and Chicken Strips.<br></span>
                        ...
                        <form action="Basket" method="post">
                            ...
                            <!-- Inputs holding info about products for basket page -->
                            <input type="hidden" value="images/chicken/Box2.jpg" name="path">
                            <input type="hidden" value="WHOLE CHICKEN" name="name">
                            <input type="hidden" value="15.00" name="prize">
                            
                            <!-- Actual view of pruduct and his details -->
                            <button type="submit" class="button_picture_content">
                                <img src="images/chicken/Box2.jpg" class="content_Image">
                                <br>WHOLE CHICKEN - FREE RANGE<br>£15.00<br>
                                <span style="font-size: 12px;">Delivery available from free for orders over £40
                                <br>Our free range & award-winning Whole Chickens are plump, succulent and with 
                                proper flavour owing to it's natural diet. These happy birds are reared with total 
                                freedom to roam their farm and are slowly nurtured with a much longer life than other 
                                commercially reared chickens. They really have to be tasted to appreciate the exceptional 
                                quality. Perfect for roasting whole as a Sunday lunch, with plenty for leftovers.<br></span>
                        ...
                        <form action="Basket" method="post">
                            ...
                            <!-- Inputs holding info about products for basket page -->
                            <input type="hidden" value="images/chicken/Box3.jpg" name="path">
                            <input type="hidden" value="10 pie premier meat" name="name">
                            <input type="hidden" value="29.50" name="prize">
                            
                            <!-- Actual view of pruduct and his details -->
                            <button type="submit" class="button_picture_content">
                                <img src="images/chicken/Box3.jpg" class="content_Image">
                                <br>10 pie premier meat box<br>£29.50<br>
                                <span style="font-size: 12px;">Delivery available from free for orders over £40
                                <br>Your mixed box order will include:<br>

                                    2 Handmade steak & kidney pies
                                    2 Handmade steak & ale pies
                                    2 Handmade chicken & mushroom pies
                                    2 Handmade chicken & ham pies
                                    2 Handmade lamb & rosemary pies<br></span>
                            </button>
